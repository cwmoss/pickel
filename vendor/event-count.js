  ...
  class extends HTMLElement {
    connectedCallback() {
      ...
      var labels = (
        this.getAttribute("hms")
          ? (([hour, minute, second] = this.getAttribute("hms").split(":")),
            (event = new Date(
              new Date() / 1 + hour * 3600e3 + minute * 60e3 + second * 1e3
            )),
            "hour,minute,second")
      ...
      var element = ({
        ...
        Object.assign(
          // Object.assign is my favorite JS function
      ...
      var attr_CSSprop = (prefix, name, value) =>
        ...
        name +
        ":" +
        (this.getAttribute(prefix + "-" + name) || // OR CSS property OR default value
              ...
              append: [
                ...
                element({
                  ...
                  innerHTML:
                    ...
                    )[2].value, // get time label name in locale as Object // get time name in locale as String)
                }),
              ],
            })
          ),

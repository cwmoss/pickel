...
import ElementManager from "./_element_manager.js";
...
export default class FormBuilder extends LitElement {
    ...
    async load_schema() {
        ...
        if (!this._schema) {
            console.log(
                "$$$ form-builder connected schema-build YES",
                this._schema,
            );
            if (text) {
    ...
    build() {
        ...
        this.element_manager = new ElementManager(this._schema);
